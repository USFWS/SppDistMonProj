---
author: "Refuge Biologist <refuge_biologist@fws.gov>"
date: "`r Sys.Date()`"
...
##save(data.list,file = paste0("../data/final/species_occurrence_data_", year, ".gzip"))
...
figdir.path <- "./figure/"
dummy <- mapply(annual.summaries, occu = sdmpData$occuDataList, site = sdmpData$siteDataList,
                year = sdmpData$years, unmkd = sdmpData$unmarkedDataList, naiveoccu = sdmpData$NaiveOccu,
